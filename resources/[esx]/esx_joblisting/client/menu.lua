...
mainMenu = NativeUI.CreateMenu(GetPlayerName(source), "Bienvenue au pole emploi!", Config.MenuX, Config.MenuY,nil,nil,nil,Config.MenuColor.r,Config.MenuColor.g,Config.MenuColor.b,Config.MenuColor.a)
_menuPool:Add(mainMenu)

function AddMenuJobMenu(menu)

        local submenu = _menuPool:AddSubMenu(menu, "Pôle emploi : ~b~jobs non whitelist", "", Config.MenuX, Config.MenuY,nil,nil,nil,Config.MenuColor.r,Config.MenuColor.g,Config.MenuColor.b,Config.MenuColor.a, 5, 50)
